...
__all__ = [
    ...
    "latest_sourcepath",
    "standard_cleanse",
    "validate_likert_scales",
    "generate_bids_sidecar",
]
...
def latest_sourcepath(filepaths):
    ...
    most_recent_index = date_times.index(max(date_times))
    filepath = filepaths[most_recent_index]
    return filepath
...
def generate_bids_sidecar(df, meta, survey_description):
    ...
    for col in df:
        column_info, probe, levels = {}, None, None
